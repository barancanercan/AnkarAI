...
class DocAIParser(BaseBlobParser):
    ...
    def online_process(
        ...
        try:
            ...
            from google.cloud.documentai_v1.types import (
                IndividualPageSelector, OcrConfig, ProcessOptions)
        except ImportError as exc:
            raise ImportError(
                "documentai package not found, please install it with"
                " `pip install google-cloud-documentai`"
        ...
        try:
            from google.cloud.documentai_toolbox.wrappers.page import \
                _text_from_layout
        except ImportError as exc:
            raise ImportError(
    ...
    def docai_parse(
        ...
        *,
        ...
        try:
            from google.cloud import documentai
            from google.cloud.documentai_v1.types import (OcrConfig,
                                                          ProcessOptions)
        except ImportError as exc:
            raise ImportError(
                "documentai package not found, please install it with"
