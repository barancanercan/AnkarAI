...
if TYPE_CHECKING:
    ...
    from langchain_community.document_loaders.assemblyai import (
        AssemblyAIAudioLoaderById, AssemblyAIAudioTranscriptLoader)
    ...
    from langchain_community.document_loaders.blob_loaders import (
        Blob, BlobLoader, FileSystemBlobLoader, YoutubeAudioLoader)
    ...
    from langchain_community.document_loaders.dedoc import (DedocAPIFileLoader,
                                                            DedocFileLoader)
    ...
    from langchain_community.document_loaders.email import (
        OutlookMessageLoader, UnstructuredEmailLoader)
    ...
    from langchain_community.document_loaders.kinetica_loader import \
        KineticaLoader
    ...
    from langchain_community.document_loaders.oracleai import (
        OracleDocLoader, OracleTextSplitter)
    from langchain_community.document_loaders.org_mode import \
        UnstructuredOrgModeLoader
    from langchain_community.document_loaders.pdf import (
        AmazonTextractPDFLoader, DedocPDFLoader, MathpixPDFLoader,
        OnlinePDFLoader, PagedPDFSplitter, PDFMinerLoader,
        PDFMinerPDFasHTMLLoader, PDFPlumberLoader, PyMuPDFLoader,
        PyPDFDirectoryLoader, PyPDFium2Loader, PyPDFLoader,
    ...
    from langchain_community.document_loaders.telegram import (
        TelegramChatApiLoader, TelegramChatFileLoader, TelegramChatLoader)
    ...
    from langchain_community.document_loaders.youtube import (
        GoogleApiClient, GoogleApiYoutubeLoader, YoutubeLoader)
