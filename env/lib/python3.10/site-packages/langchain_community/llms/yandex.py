...
async def _amake_request(self: YandexGPT, prompt: str) -> str:
    try:
        ...
        try:
            ...
            from yandex.cloud.ai.foundation_models.v1.text_generation.text_generation_service_pb2_grpc import \
                TextGenerationAsyncServiceStub  # noqa: E501
        except ModuleNotFoundError:
            from yandex.cloud.ai.foundation_models.v1.foundation_models_pb2 import (
                CompletionOptions,
                Message,
        ...
        from yandex.cloud.operation.operation_service_pb2 import \
            GetOperationRequest
