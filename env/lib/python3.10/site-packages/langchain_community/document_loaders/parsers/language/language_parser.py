...
from langchain_community.document_loaders.parsers.language.cobol import \
    CobolSegmenter
from langchain_community.document_loaders.parsers.language.cpp import \
    CPPSegmenter
from langchain_community.document_loaders.parsers.language.csharp import \
    CSharpSegmenter
from langchain_community.document_loaders.parsers.language.elixir import \
    ElixirSegmenter
from langchain_community.document_loaders.parsers.language.go import \
    GoSegmenter
...
from langchain_community.document_loaders.parsers.language.javascript import \
    JavaScriptSegmenter
from langchain_community.document_loaders.parsers.language.kotlin import \
    KotlinSegmenter
from langchain_community.document_loaders.parsers.language.lua import \
    LuaSegmenter
from langchain_community.document_loaders.parsers.language.perl import \
    PerlSegmenter
from langchain_community.document_loaders.parsers.language.php import \
    PHPSegmenter
from langchain_community.document_loaders.parsers.language.python import \
    PythonSegmenter
from langchain_community.document_loaders.parsers.language.ruby import \
    RubySegmenter
from langchain_community.document_loaders.parsers.language.rust import \
    RustSegmenter
from langchain_community.document_loaders.parsers.language.scala import \
    ScalaSegmenter
