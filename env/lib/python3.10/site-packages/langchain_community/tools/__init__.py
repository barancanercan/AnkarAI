...
if TYPE_CHECKING:
    ...
    from langchain_community.tools.azure_ai_services import (
        ...
        AzureAiServicesImageAnalysisTool, AzureAiServicesSpeechToTextTool,
    ...
    from langchain_community.tools.cassandra_database.tool import (  # noqa: F401
        GetSchemaCassandraDatabaseTool, GetTableDataCassandraDatabaseTool,
        QueryCassandraDatabaseTool)
    from langchain_community.tools.cogniswitch.tool import (
        CogniswitchKnowledgeRequest, CogniswitchKnowledgeSourceFile,
        CogniswitchKnowledgeSourceURL, CogniswitchKnowledgeStatus)
    ...
    from langchain_community.tools.google_search.tool import (
        GoogleSearchResults, GoogleSearchRun)
    from langchain_community.tools.google_serper.tool import (
        GoogleSerperResults, GoogleSerperRun)
    ...
    from langchain_community.tools.reddit_search.tool import (
        RedditSearchRun, RedditSearchSchema)
    ...
    from langchain_community.tools.searx_search.tool import (
        SearxSearchResults, SearxSearchRun)
    ...
    from langchain_community.tools.sql_database.tool import (
        BaseSQLDatabaseTool, InfoSQLDatabaseTool, ListSQLDatabaseTool,
    ...
    from langchain_community.tools.zapier.tool import (ZapierNLAListActions,
                                                       ZapierNLARunAction)
    from langchain_community.tools.zenguard.tool import (Detector,
                                                         ZenGuardInput,
                                                         ZenGuardTool)
