...
if TYPE_CHECKING:
    ...
    from langchain_community.retrievers.azure_ai_search import (
        AzureAISearchRetriever, AzureCognitiveSearchRetriever)
    ...
    from langchain_community.retrievers.llama_index import (
        LlamaIndexGraphRetriever, LlamaIndexRetriever)
    ...
    from langchain_community.retrievers.thirdai_neuraldb import \
        NeuralDBRetriever
