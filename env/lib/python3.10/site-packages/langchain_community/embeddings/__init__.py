...
if TYPE_CHECKING:
    ...
    from langchain_community.embeddings.ascend import AscendEmbeddings
    ...
    from langchain_community.embeddings.fake import (
        DeterministicFakeEmbedding, FakeEmbeddings)
    ...
    from langchain_community.embeddings.mlflow import (MlflowCohereEmbeddings,
                                                       MlflowEmbeddings)
